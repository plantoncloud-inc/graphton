...
class TestEnhanceUserInstructions:
    ...
    def test_enhancement_preserves_user_instructions(self):
    ...
    def test_enhancement_includes_planning_section(self):
    ...
    def test_enhancement_includes_file_system_section(self):
    ...
    def test_enhancement_includes_mcp_tools_when_configured(self):
    ...
    def test_enhancement_excludes_mcp_tools_when_not_configured(self):
    ...
    def test_enhancement_is_concise(self):
    ...
    def test_enhancement_mentions_when_to_use_planning(self):
    ...
    def test_file_system_path_requirement_mentioned(self):
    ...
    def test_enhancement_with_already_detailed_instructions(self):
    ...
    def test_different_mcp_configurations_produce_different_results(self):
